...
const upload = multer()
const { createBlogController, getAllBlogsController, getBlogBySlug, getSingleBlogController, searchTermsController, updateBlogController, deleteSingleBlogController } = require('../../controllers/blog/blogController')
...
blogApi.delete('/v1/delete-blog/:id',authMiddleware,deleteSingleBlogController)
// comments api
